...
# test = f'{INPUT_PART}/green_{DATASET}/*/*.{INPUT_FILETYPE}',

# NOTE: DAG declaration - using a Context Manager (an implicit way)
with DAG(
        dag_id="gcs_2_bq_dag10",
    ...
    for colour, ds_col in COLOUR_RANGE.items():
        move_files_gcs_task = GCSToGCSOperator(
            ...
            source_bucket=BUCKET,  # dtc_data_lake_dataengineeringcourse-352916
            # source_object=f'{INPUT_PART}/{colour}_{DATASET}/2019/{colour}_{DATASET}*.{INPUT_FILETYPE}',
            source_object=f'{INPUT_PART}/{colour}_{DATASET}/2021/*',
            # source_objects=[
            #     f'{INPUT_PART}/{colour}_{DATASET}/2019/*.{INPUT_FILETYPE}',
            #     f'{INPUT_PART}/{colour}_{DATASET}/2020/*.{INPUT_FILETYPE}',
            #     f'{INPUT_PART}/{colour}_{DATASET}/2021/*.{INPUT_FILETYPE}'
            # ],

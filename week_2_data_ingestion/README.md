...
#### What is a Data Lake:
- secure, scalable & affordable, capable od storing large amounts of data
- has unstructured data
- intended for data scientists & data analysts
- **Ideology:** store all the available data even before knowing whether the data is useful or not
- **Use cases:** stream processing, machine learning, realtime analytics
#### What is a Data Warehouse:
- structured data, small datasize
- intended for business analysts
- **Use cases:** batch processing, BI reporting
#### ELT vs. ETL
- **ETL:** Export Transform Load 
  - for small amounts of data
  - e.g define schema on write & then you write the data
- **ELT:** Export Load Transform 
  - for large amounts of data
  - provides data lake support
  - e.g schema on read, you write the data and determine the schema on the read
